 ...
 *
 */
public class StreamingTransformator implements AutoCloseable {
    ...
    /**
     * Creates a new {@link Builder} instance to build a new
     * {@link StreamingTransformator}.
     * 
     * @return a new {@link Builder} instance to build a new
     *         {@link StreamingTransformator}.
     */
    ...
    /**
     * The Builder of the {@link StreamingTransformator} class. It can be extended
     * to allow more complex transformations.
     * 
     * @author Michael R&ouml;der (michael.roeder@uni-paderborn.de)
     *
     */
    public static class Builder {
        ...
        protected Lang outputFormat = Lang.NTRIPLES;

        public StreamingTransformator build() throws IOException {
        ...
        protected File createOutputFile() {
            ...
            if (outputFormat.getFileExtensions().size() > 0) {
                outputFileBuilder.append('.');
                outputFileBuilder.append(outputFormat.getFileExtensions().get(0));
            }
         ...
         */
        public Builder setOutputFormat(Lang outputFormat) {
